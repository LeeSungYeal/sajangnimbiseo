...
"[project]/src/app/dashboard/announcements/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AnnouncementsPage() {
    ...
    async function fetchAnnouncements() {
        setLoading(true);
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("announcements").select("*").eq("is_active", true).order("deadline", {
            ascending: true
        });
        if (!error && data) {
...
//# sourceMappingURL=src_e382a52b._.js.map