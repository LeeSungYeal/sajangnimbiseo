...
function AnnouncementsPage() {
    ...
    async function fetchAnnouncements() {
        setLoading(true);
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("announcements").select("*").eq("is_active", true).order("announce_date", {
            ascending: true
        });
        if (!error && data) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2cd3b2f5._.js.map